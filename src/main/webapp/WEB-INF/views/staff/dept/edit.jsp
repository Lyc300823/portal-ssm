...
<form class="layui-form" lay-filter="form" action="dept/save" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block"
            ...
            <input type="radio" name="isLeaf"
                   value="0" title="允许"
                   ${dept.isLeaf==0?'checked':''}
            >
            <input type="radio"
                   name="isLeaf"
                   value="1" title="不允许"
                  ${dept.isLeaf==1?'checked':''}
            >
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            >
                ...
                <c:forEach items="${iconList}" var="icon">
                    <option value="${icon}" ${dept.icon==icon?'selected':''}>${icon}</option>
                </c:forEach>
            </select>
        </div>
    </div>
